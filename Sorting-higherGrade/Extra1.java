...
//Augment the test code from assignment 1 (which is explained below ) so that the array is sorted in descending order instead of ascending order(this happens in main)
